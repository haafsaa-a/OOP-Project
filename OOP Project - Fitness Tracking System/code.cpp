                                        ...
                                        if (diet_plan == "1")
                                        {
                                            ...
                                            while (1)
                                            {
                                                ...
                                                else if (plan == "1")
                                                {
                                                    DIR *dr;
                                                    struct dirent *en;
                                                    dr = opendir("H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Lose Weight/");
                                                    if (dr)
                                                    {
                                                        int filecount = 0;
                                                        while ((en = readdir(dr)) != NULL)
                                                    ...
                                                    if (dr)
                                                    {
                                                        ...
                                                        while ((en = readdir(dr)) != NULL)
                                                        {
                                                            if (strcmp(en->d_name, ".") != 0 && strcmp(en->d_name, "..") != 0)
                                                            {
                                                                ...
                                                                if (currentfile == choice)
                                                                {
                                                                    ifstream file("H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Lose Weight/" + string(en->d_name));
                                                                    if (file.is_open())
                                                                    {
                                                                        string getplan;
                                                                        while (getline(file, getplan))
                        ...
                        while (1)
                        {
                            ...
                            else
                            {
                                ...
                                else if (goal == (f1.getUserCal() + e1.getusercal()))
                                {
                                    ...
                                    string filePath = "H:/3rd Semester/Object Oriented Programming/Project/Fitness Tracking System/Lose Weight/" + username;
